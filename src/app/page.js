    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-gray-900 via-gray-800 to-gray-900">
          <div className="absolute top-0 right-0 w-125 h-125 bg-yellow-500/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-100 h-100 bg-yellow-600/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                className="inline-flex items-center gap-2 bg-yellow-500/10 backdrop-blur border border-yellow-500/30 text-yellow-400 px-4 py-2 rounded-full text-sm font-medium mb-6"
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-linear-to-r from-green-500 to-green-600 text-white px-6 py-4 rounded-full font-semibold hover:from-green-400 hover:to-green-500 transition-all duration-300 shadow-xl shadow-green-500/30 hover:shadow-green-500/50"
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
                  <Link
                    href="/projects"
                    className="inline-flex items-center justify-center gap-2 border border-white/30 text-white px-6 py-4 rounded-full font-semibold hover:bg-white/10 transition-all duration-300"
                  >
                    View Our Projects
